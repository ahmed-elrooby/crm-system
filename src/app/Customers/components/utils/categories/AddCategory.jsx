...
const AddCategory = () => {
  const { handleAddCategorySubmit, openAddCategory, setOpenAddCategory } =
          ...
          <Formik
            ...
            onSubmit={async (values, { setSubmitting, resetForm }) => {
              try {
                ...
                await handleAddCategorySubmit(payload);
              ...
              <Form className="flex flex-col flex-1 min-h-0">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-slate-400">
                          يمكنك تعطيل التصنيف إذا لم تعد بحاجة إليه
                        </p>
                      </div>
                    </div>
                ...
                <div className="flex items-center flex-shrink-0 gap-3 px-6 py-4 border-t bg-slate-50 border-slate-100">
                  ...
                  >
                    ...
                    {isSubmitting ? "جاري الحفظ..." : "إضافة التصنيف"}
                  </button>
